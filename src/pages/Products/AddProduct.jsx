...
const AddProduct = () => {
  ...
  setUnitIdValue(event.target.value);
    ...
    const submitData = () => {
      ...
      setIsSaving(true);
      axios.post('http://127.0.0.1:8000/api/v1/products/create', {
        ...
        .then(function (response) {
          ...
          // success response
          console.log("Success submitting product data",response.data )
        })
        ...
        .catch(function (error) {
          ...
          console.log("Error submitting product  data",error.response.data )
          setIsSaving(false)
        });
  }
